...
//RUNTIME_OPTIONS -Dlogging.level.root=INFO
//RUNTIME_OPTIONS -Dspring.ai.mcp.client.stdio.connections.weather.command=jbang
//RUNTIME_OPTIONS -Dspring.ai.mcp.client.stdio.connections.weather.args=./McpServerStdio.java
...
public class McpClientStdio {
  ...
  void main(String... args) {
    SpringApplication.run(McpClientStdio.class, args);
  }
}
